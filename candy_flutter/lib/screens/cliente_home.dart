...
import './perfil.dart';
import 'cliente_screens/citas_cliente.dart';
...
const String frases = '¡Bienvenido a la app!';

class _ClienteHomeState extends State<ClienteHome> {
  Widget _buildPage(String frases) {
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            "'Tus manos dicen mucho de ti, y cada detalle cuenta. Permítenos realzar su belleza con dedicación, precisión y los mejores cuidados. Aquí no solo te hacemos la manicura, te ofrecemos un momento de relajación y confianza para que te sientas increíble en cada ocasión.' \n J balvin 2:20 cuando pusieron la cancion",
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Cliente - ${user?['nombre'] ?? 'Cargando...'}'),
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    onTap: () {
                      ...
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => const MisCitasPage()),
                      );
                    },
                  ),
                  ListTile(
